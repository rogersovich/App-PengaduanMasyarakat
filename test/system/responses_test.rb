...
class ResponsesTest < ApplicationSystemTestCase
  ...
  test "creating a Response" do
    ...
    fill_in "Complaint id", with: @response.complaint_id_id
    fill_in "Tanggal", with: @response.tanggal
    fill_in "Tanggapan", with: @response.tanggapan
    fill_in "User id", with: @response.user_id_id
