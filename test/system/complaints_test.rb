...
class ComplaintsTest < ApplicationSystemTestCase
  ...
  test "creating a Complaint" do
    ...
    fill_in "Foto", with: @complaint.foto
    fill_in "Isi laporan", with: @complaint.isi_laporan
    fill_in "Society id", with: @complaint.society_id_id
    fill_in "Status", with: @complaint.status
    fill_in "Tanggal", with: @complaint.tanggal
