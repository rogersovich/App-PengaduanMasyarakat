...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { foto: @complaint.foto, isi_laporan: @complaint.isi_laporan, society_id_id: @complaint.society_id_id, status: @complaint.status, tanggal: @complaint.tanggal } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { foto: @complaint.foto, isi_laporan: @complaint.isi_laporan, society_id_id: @complaint.society_id_id, status: @complaint.status, tanggal: @complaint.tanggal } }
